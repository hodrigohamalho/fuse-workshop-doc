...
. In the *Search Catalog* box at the top, search for *fuse console* & select the *Red Hat Fuse 7.4 Console* (*NOT* the one that has the *(cluser)* appendix) option
+
