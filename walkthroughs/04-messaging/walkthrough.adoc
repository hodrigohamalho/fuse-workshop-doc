...
Check the logs to see the message being exchanged in the queue. As we are using an embedded broker to test our application without the need to deploy in any place, 
...
If your project was provisioned correctly you will see a screen like this:
