...
Using the *fuse-workshop* project, open the class `OrderGenerator.java`.
...
https://github.com/apache/camel/blob/master/components/readme.adoc[Take a look at the camel components]
...
Use *CTLR* + *SPACE* to use the auto complete feature, if it is available.
