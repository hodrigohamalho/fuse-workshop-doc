...
Content-Based Router (CBR) is a pattern from the Enterprise Integration Pattern. You will use CBR when you need 
...
If you would like to consume files from FTP and work as a Java Object, 
instead to use marshal, you must use *unmarshal()*, example:
...
We see a lot of things during this lab, a quick recap:
