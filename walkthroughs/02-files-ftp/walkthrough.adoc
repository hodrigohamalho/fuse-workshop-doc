...
Let's understand the basic concepts of Camel, exploring a use case with *FILE* and *FTP* component doing some 
...
[type=verification]
Do you see the files inside the directory ?
...
[type=verification]
Do you see the last XML files uploaded with the process attribute as true?
